...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  */
    ...
    PB9     ------> I2C1_SDA
    */
    GPIO_InitStruct.Pin = GY_280_SCL_Pin|GY_280_SDA_Pin;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB9     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(GY_280_SCL_GPIO_Port, GY_280_SCL_Pin);

    HAL_GPIO_DeInit(GY_280_SDA_GPIO_Port, GY_280_SDA_Pin);
